...
--consulta con alias
SELECT podekex AS numero FROM pokemones WHERE nombre = 'Eevee';
...
INSERT INTO mis_pokemones (pokedex, fecha_captura, lugar, huevo, peso, estatura)
VALUES (134, '2021-04-12', 'La loma del toro', false, 25.6, 0.80);
...
--ejecutar consulta con order by peso maximo 5
